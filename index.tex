...
\hypersetup{
  pdftitle={R basics for Research},
  pdfauthor={Marcelino Guerra},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
This book is a gentle introduction on how to program in R. Hands-on
examples show challenges that researchers frequently face and how to
overcome common issues associated to data visualization and data
wrangling.

\bookmarksetup{startatroot}

\hypertarget{setting-things-up}{%
\chapter{Setting things up}\label{setting-things-up}}
...
\hypertarget{creating-a-rmarkdown-document}{%
\section{Creating a Rmarkdown
Document}\label{creating-a-rmarkdown-document}}
...
\hypertarget{data-with-r}{%
\section{Data with R}\label{data-with-r}}

\hypertarget{loading-data}{%
\subsection{Loading Data}\label{loading-data}}

\hypertarget{data-structures-types}{%
\subsection{Data Structures \& Types}\label{data-structures-types}}

\bookmarksetup{startatroot}

\hypertarget{data-wrangling-with-tidyverse}{%
\chapter{Data Wrangling with
